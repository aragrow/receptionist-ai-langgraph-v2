...
---
## Branch: dev-3
**Created:** 2025-09-23 09:29:12  
**Commit Message:** Uvicorn server starts.
...
```
 ...
 main.py                                  |   79 +
 pyproject.toml                           |    8 +-
 src/models/database_models.py            |  114 ++
 src/models/workflow_models.py            |   56 +
 src/nodes/context_builder.py             |   30 +
 src/nodes/identity_checker.py            |   44 +
 src/nodes/intent_analyzer.py             |   50 +
 src/nodes/response_generator.py          |   82 +
 src/services/context_service.py          |  106 ++
 src/services/database_service.py         |  109 ++
 src/services/embedding_service.py        |   72 +
 src/utilities/phone_utils.py             |   43 +
 src/utilities/text_processing.py         |   45 +
 src/workflow/ai_receptionist_workflow.py |   70 +
 src/workflow/workflow_runner.py          |   72 +
 tests/test_workflow.py                   |   58 +
 uv.lock                                  | 3051 ++++++++++++++++++++++++++++++
 19 files changed, 4381 insertions(+), 1 deletion(-)
```
...
+            return [0.0] * 500
\ No newline at end of file
diff --git a/src/utilities/phone_utils.py b/src/utilities/phone_utils.py
new file mode 100644
index 0000000..3937f27
--- /dev/null
+++ b/src/utilities/phone_utils.py
@@ -0,0 +1,43 @@
...
\ No newline at end of file
diff --git a/src/utilities/text_processing.py b/src/utilities/text_processing.py
new file mode 100644
index 0000000..70e2fc9
--- /dev/null
+++ b/src/utilities/text_processing.py
@@ -0,0 +1,45 @@
...
+    { name = "attrs" },
+    { name = "backoff" },
+    { name = "black", marker = "extra == 'linting'" },
...
+    { name = "httpx" },
+    { name = "idna" },
+    { name = "isort", marker = "extra == 'linting'" },
+    { name = "jsonpatch" },
+    { name = "jsonpointer" },
+    { name = "langchain" },
+    { name = "langchain-core" },
...
+    { name = "mando" },
+    { name = "markdown-it-py" },
+    { name = "mccabe", marker = "extra == 'linting'" },
+    { name = "mdurl" },
+    { name = "motor", specifier = ">=3.7.1" },
+    { name = "multidict" },
+    { name = "mypy", marker = "extra == 'dev'" },
+    { name = "mypy-extensions", marker = "extra == 'dev'" },
...
+    { name = "packaging" },
+    { name = "pandas" },
+    { name = "pathspec", marker = "extra == 'dev'" },
+    { name = "platformdirs", marker = "extra == 'dev'" },
+    { name = "propcache" },
+    { name = "proto-plus" },
+    { name = "protobuf" },
+    { name = "pyasn1" },
+    { name = "pyasn1-modules" },
+    { name = "pycodestyle", marker = "extra == 'linting'" },
+    { name = "pydantic" },
+    { name = "pydantic-core" },
+    { name = "pydantic-settings" },
+    { name = "pyflakes", marker = "extra == 'linting'" },
...
+    { name = "pytz" },
+    { name = "pyyaml" },
+    { name = "radon", marker = "extra == 'linting'" },
+    { name = "requests" },
+    { name = "requests-toolbelt" },
+    { name = "rich" },
+    { name = "rsa" },
...
+    { name = "zstandard" },
+]
+provides-extras = ["dev", "linting", "testing"]
+
+[[package]]
+name = "aiofiles"
+version = "24.1.0"
...
+version = "1.0.2"
+source = { registry = "https://pypi.org/simple" }
+sdist = { url = "https://files.pythonhosted.org/packages/13/6f/0e2d42c0e95d50edf63147b8a742703061945e02760f25d6a0e8f028ccb0/asyncio-throttle-1.0.2.tar.gz", hash = "sha256:2675282e99d9129ecc446f917e174bc205c65e36c602aa18603b4948567fcbd4", size = 3775, upload-time = "2021-04-07T13:37:50.114Z" }
+wheels = [
+    { url = "https://files.pythonhosted.org/packages/f6/6a/d18c93722fb56dc1ffed5fb7e7fcff4f8031f80f84c5cc0427363a036b0c/asyncio_throttle-1.0.2-py3-none-any.whl", hash = "sha256:4d4c1eb3250f735f59ce842d8d92cd2927c008bd52008797ba030b5787c41f3b", size = 4079, upload-time = "2021-04-07T13:37:48.63Z" },
+]
+
+[[package]]
+name = "attrs"
